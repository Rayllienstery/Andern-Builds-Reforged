...
internal static class OpenMapShotgunLimit
{
    public const int RerollShotgunChancePercent = 90;
        ...
        MongoId botId)
    {
        ...
        if (location == null || FactoryMaps.Contains(location) || !OpenMaps.Contains(location))
        {
            return;
        }
        ...
        if (!randomUtil.GetChance100(RerollShotgunChancePercent))
        {
            return;
        }
